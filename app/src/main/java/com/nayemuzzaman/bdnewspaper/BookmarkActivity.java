...
import static com.nayemuzzaman.bdnewspaper.prothomalo.PREFERENCES;
import static com.nayemuzzaman.bdnewspaper.prothomalo.WEB_LINKS;
import static com.nayemuzzaman.bdnewspaper.prothomalo.WEB_TITLE;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (o instanceof Map) {
                    Map map = (Map) o;
                    Intent in = new Intent(BookmarkActivity.this, prothomalo.class);
